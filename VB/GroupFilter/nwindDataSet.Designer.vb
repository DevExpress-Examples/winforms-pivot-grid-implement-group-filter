...
Namespace GroupFilter
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddSalesPersonRow(ByVal ProductName As String, ByVal OrderDate As System.DateTime, ByVal Extended_Price As Decimal, ByVal CategoryName As String) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { ProductName, OrderDate, Extended_Price, CategoryName}
	...
	End Class
End Namespace
Namespace GroupFilter.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        ProductName, OrderDate, [Extended Price], CategoryName" & Constants.vbCrLf & "FROM       " & "     SalesPerson"
